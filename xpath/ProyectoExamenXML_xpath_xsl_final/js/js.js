...
function corrigePregunta5(){
	...
	var useranswer = datosXml.createElement("useranswer");   
  	useranswer.innerHTML = document.getElementById("P5R").value;
  	datosXml.getElementById("jdos_005").appendChild(useranswer);
